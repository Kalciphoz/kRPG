...
namespace kRPG.Content.Items.Projectiles.Base
{
    public class kProjectile : GlobalProjectile
    {
        ...
        {
            if (ElementalDamage != null || Main.netMode == NetmodeID.MultiplayerClient)
                return;
                    ...
                    {
                        {
                            ...
                            Main.rand.Next(10) == 0 && Main.netMode == NetmodeID.MultiplayerClient
                        },
                        {
                            Element.Cold,
                        ...
                        },
                        {
                            ...
                            !Main.dayTime && Main.rand.Next(10) == 0 && Main.netMode ==NetmodeID.MultiplayerClient && player.ZoneOverworldHeight
                        }
                    };
