...
namespace kRPG.Content.GFX
{
    public static class GFX
    {
        ...
        private const string GUI_DIRECTORY = "Content/GFX/GUI/";
        ...
        private const string LEVELUPSOUND = "Content/SFX/LevelUP";
        ...
        private const string PROJECTILES_DIRECTORY = "Content/GFX/Projectiles/";
