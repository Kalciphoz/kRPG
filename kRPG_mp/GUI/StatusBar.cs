...
namespace kRPG_mp.GUI
{
    public class StatusBar : BaseGUI
    {
        ...
        public StatusBar(PlayerCharacter character, Mod mod) : base()
        {
            ...
            AddButton(delegate () { return new Rectangle((int)(points_origin.X), (int)(points_origin.Y * scale), (int)(GFX.unspentPoints.Width * scale), (int)(GFX.unspentPoints.Height * scale)); }, delegate (Player player)
            {
                character.CloseGUIs();
