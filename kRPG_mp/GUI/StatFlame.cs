...
namespace kRPG_mp.GUI
{
    public class StatFlame
    {
        ...
        public StatFlame(PlayerCharacter character, Mod mod, LevelGUI levelGUI, STAT id, Func<Vector2> position, Texture2D texture)
        {
        ...
        public void Draw(SpriteBatch spriteBatch, float scale = 1f)
        {
            ...
            spriteBatch.DrawStringWithShadow(Main.fontItemStack, text, position() + new Vector2(28f - width / 2f, 36f), allocated > 0 ? Color.Lime : Color.White, 1f);
            counter++;
        }
