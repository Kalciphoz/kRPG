...
namespace kRPG.GameObjects.GFX
{
    public static class GFX
    {
        ...
        private const string GUI_DIRECTORY = "GameObjects/GFX/GUI/";
        ...
        private const string LEVELUP = GUI_DIRECTORY + "LevelUP";
        private const string LEVELUPSOUND = "GameObjects/SFX/LevelUP";
        ...
        private const string PROJECTILES_DIRECTORY = "GameObjects/GFX/Projectiles/";
