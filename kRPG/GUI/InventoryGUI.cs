...
namespace kRPG.GUI
{
    public class InventoryGUI : BaseGUI
    {
        ...
        private void DrawStatPage(SpriteBatch spriteBatch, PlayerCharacter character)
        {
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, (character.ExperienceToLevel() - character.xp) + " XP to level", panelOrigin + new Vector2(24f, 24f) * scale, Color.White, 0.8f * scale);
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, "Resilience:", panelOrigin + new Vector2(24f, 42f) * scale, new Color(223, 0, 0), 0.8f * scale);
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, character.TotalStats(STAT.RESILIENCE).ToString(), panelOrigin + new Vector2(128f, 42f) * scale, Color.White, 0.8f * scale);
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, "Quickness:", panelOrigin + new Vector2(24f, 60f) * scale, new Color(0, 191, 31), 0.8f * scale);
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, character.TotalStats(STAT.QUICKNESS).ToString(), panelOrigin + new Vector2(128f, 60f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, character.TotalStats(STAT.POTENCY).ToString(), panelOrigin + new Vector2(128f, 78f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, character.TotalStats(STAT.WITS).ToString(), panelOrigin + new Vector2(128f, 96f) * scale, Color.White, 0.8f * scale);
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, "Damage:", panelOrigin + new Vector2(24f, 114f) * scale, Color.White, 0.8f * scale);
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, Math.Round(character.damageMultiplier * 100f) + "%", panelOrigin + new Vector2(128f, 114f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, Math.Round(1f / character.player.meleeSpeed * 100f) + "%", panelOrigin + new Vector2(128f, 132f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, "+" + character.critBoost.ToString() + "%", panelOrigin + new Vector2(120f, 150f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, Math.Round((character.damageMultiplier + character.critMultiplier) * 200f) + "%", panelOrigin + new Vector2(128f, 168f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, character.player.statDefense.ToString(), panelOrigin + new Vector2(128f, 184f) * scale, Color.White, 0.8f * scale);

            spriteBatch.DrawStringWithShadow(Main.fontMouseText, "Fire resistance:", panelOrigin + new Vector2(184f, 42f) * scale, new Color(255, 63, 0), 0.8f * scale);
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, character.resistance[ELEMENT.FIRE].ToString(), panelOrigin + new Vector2(288f, 42f) * scale, Color.White, 0.8f * scale);
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, "Cold resistance:", panelOrigin + new Vector2(184f, 60f) * scale, new Color(63, 127, 255), 0.8f * scale);
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, character.resistance[ELEMENT.COLD].ToString(), panelOrigin + new Vector2(288f, 60f) * scale, Color.White, 0.8f * scale);
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, "Light. resist.:", panelOrigin + new Vector2(184f, 78f) * scale, new Color(255, 239, 0), 0.8f * scale);
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, character.resistance[ELEMENT.LIGHTNING].ToString(), panelOrigin + new Vector2(288f, 78f) * scale, Color.White, 0.8f * scale);
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, "Shadow resist.:", panelOrigin + new Vector2(184f, 96f) * scale, new Color(95, 0, 191), 0.8f * scale);
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, character.resistance[ELEMENT.SHADOW].ToString(), panelOrigin + new Vector2(288f, 96f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, character.evasion.ToString(), panelOrigin + new Vector2(288f, 114f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, Math.Round((80f - (80 * 25) / (25 + character.evasion))) + "%", panelOrigin + new Vector2(288f, 132f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, Math.Round((90f - (90 * 38) / (38 + character.evasion + character.TotalStats(STAT.WITS) * 2))).ToString() + "%", panelOrigin + new Vector2(288f, 150f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, character.accuracy.ToString(), panelOrigin + new Vector2(288f, 168f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, Math.Round(character.hitChance * 100) + "%", panelOrigin + new Vector2(288f, 186f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, (Math.Round(character.lifeRegen * 10) / 10).ToString(), panelOrigin + new Vector2(448f, 42f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, (Math.Round(character.manaRegen * 10) / 10).ToString(), panelOrigin + new Vector2(448f, 60f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, Math.Round(character.player.moveSpeed * 100) + "%", panelOrigin + new Vector2(448f, 78f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, character.player.jumpSpeedBoost.ToString(), panelOrigin + new Vector2(448f, 96f) * scale, Color.White, 0.8f * scale);
            ...
            spriteBatch.DrawStringWithShadow(Main.fontMouseText, (character.lifeLeech * 100) + "%", panelOrigin + new Vector2(448f, 114f) * scale, Color.White, 0.8f * scale);
        }
        ...
        private void DrawHotbar(SpriteBatch spriteBatch)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                if (Main.mouseX >= x2 && Main.mouseX <= x2 + Main.inventoryBackTexture.Width * Main.inventoryScale && Main.mouseY >= y2 && Main.mouseY <= y2 + Main.inventoryBackTexture.Height * Main.inventoryScale && !PlayerInput.IgnoreMouseInterface)
                {
        ...
        private void Vanilla(bool drawInv)
        {
            try
            {
                ...
                if (Main.mouseX >= num && Main.mouseX <= num + Main.inventoryBackTexture.Width * Main.inventoryScale && Main.mouseY >= num2 && Main.mouseY <= num2 + Main.inventoryBackTexture.Height * Main.inventoryScale && !PlayerInput.IgnoreMouseInterface)
                {
                    Main.player[Main.myPlayer].mouseInterface = true;
                    if (Main.mouseLeftRelease && Main.mouseLeft)
                    {
                ...
                ItemSlot.Draw(Main.spriteBatch, ref Main.player[Main.myPlayer].trashItem, 6, new Vector2(num, num2), default(Color));
                ...
                if (!PlayerInput.UsingGamepad)
                {
                    ...
                    Main.spriteBatch.Draw(Main.HBLockTexture[num6], new Vector2(num7, num8), new Rectangle?(new Rectangle(0, 0, Main.HBLockTexture[num6].Width, Main.HBLockTexture[num6].Height)), Main.inventoryBack, 0f, default(Vector2), 0.9f, SpriteEffects.None, 0f);
                ...
                new Color((int)((byte)(Main.mouseTextColor * Main.armorAlpha)), (int)((byte)(Main.mouseTextColor * Main.armorAlpha)), (int)((byte)(Main.mouseTextColor * Main.armorAlpha)), (int)((byte)(Main.mouseTextColor * Main.armorAlpha)));
                ...
                if (Main.EquipPage == 2)
                {
                    ...
                    Rectangle r = new Rectangle(0, 0, (int)((float)Main.inventoryBackTexture.Width * Main.inventoryScale), (int)(Main.inventoryBackTexture.Height * Main.inventoryScale));
                ...
                else if (Main.EquipPage == 1)
                {
                    ...
                    for (int num35 = 0; num35 < Main.npcHeadTexture.Length; num35++)
                    {
                        ...
                        if (flag3)
                        {
                            ...
                            Main.spriteBatch.Draw(texture, new Vector2(num38, num39), new Rectangle?(new Rectangle(0, 0, Main.inventoryBackTexture.Width, Main.inventoryBackTexture.Height)), white2, 0f, default(Vector2), Main.inventoryScale, SpriteEffects.None, 0f);
                            white = Color.White;
                            int num40 = num35;
                            float s = 1f;
                            float num41;
                ...
                else
                {
                    ...
                    for (int num46 = 0; num46 < num44; num46++)
                    {
                        ...
                        else if (Main.mouseX >= num47 && Main.mouseX <= num47 + Main.inventoryBackTexture.Width * Main.inventoryScale && Main.mouseY >= num48 && Main.mouseY <= num48 + Main.inventoryBackTexture.Height * Main.inventoryScale && !PlayerInput.IgnoreMouseInterface)
                        {
                            Main.armorHide = true;
                            Main.player[Main.myPlayer].mouseInterface = true;
                        ...
                        ItemSlot.Draw(Main.spriteBatch, Main.player[Main.myPlayer].armor, context2, num46, new Vector2(num47, num48), default(Color));
                    ...
                    if (Main.mouseX > Main.screenWidth - 64 - 28 - 47 && Main.mouseX < (int)((Main.screenWidth - 64 - 20 - 47) + 56f * Main.inventoryScale) && Main.mouseY > 174 + (int)mH.GetValue(null) && Main.mouseY < (int)((174 + (int)mH.GetValue(null)) + 168f * Main.inventoryScale) && !PlayerInput.IgnoreMouseInterface)
                    {
                        Main.player[Main.myPlayer].mouseInterface = true;
                    }
                    for (int num52 = 10; num52 < 10 + num44; num52++)
                    {
                        ...
                        if (Main.mouseX >= num53 && Main.mouseX <= num53 + Main.inventoryBackTexture.Width * Main.inventoryScale && Main.mouseY >= num54 && Main.mouseY <= num54 + Main.inventoryBackTexture.Height * Main.inventoryScale && !PlayerInput.IgnoreMouseInterface)
                        {
                            Main.player[Main.myPlayer].mouseInterface = true;
                            Main.armorHide = true;
                        ...
                        ItemSlot.Draw(Main.spriteBatch, Main.player[Main.myPlayer].armor, context3, num52, new Vector2(num53, num54), default(Color));
                    }
                    Main.inventoryBack = color;
                    if (Main.mouseX > Main.screenWidth - 64 - 28 - 47 && Main.mouseX < (int)((Main.screenWidth - 64 - 20 - 47) + 56f * Main.inventoryScale) && Main.mouseY > 174 + (int)mH.GetValue(null) && Main.mouseY < (int)((174 + (int)mH.GetValue(null)) + 168f * Main.inventoryScale) && !PlayerInput.IgnoreMouseInterface)
                    {
                    ...
                    for (int num55 = 0; num55 < num44; num55++)
                    {
                        ...
                        if (Main.mouseX >= num56 && Main.mouseX <= num56 + Main.inventoryBackTexture.Width * Main.inventoryScale && Main.mouseY >= num57 && Main.mouseY <= num57 + Main.inventoryBackTexture.Height * Main.inventoryScale && !PlayerInput.IgnoreMouseInterface)
                        {
                            Main.player[Main.myPlayer].mouseInterface = true;
                            Main.armorHide = true;
                ...
                if (Main.InReforgeMenu)
                {
                    ...
                    else
                    {
                        ...
                        ChatManager.DrawColorCodedStringWithShadow(Main.spriteBatch, Main.fontMouseText, text2, new Vector2((num60 + 50), num61), new Color(Main.mouseTextColor, Main.mouseTextColor, Main.mouseTextColor, Main.mouseTextColor), 0f, Vector2.Zero, Vector2.One, -1f, 2f);
                        if (Main.mouseX >= num60 && Main.mouseX <= num60 + Main.inventoryBackTexture.Width * Main.inventoryScale && Main.mouseY >= num61 && Main.mouseY <= num61 + Main.inventoryBackTexture.Height * Main.inventoryScale && !PlayerInput.IgnoreMouseInterface)
                        {
                            Main.player[Main.myPlayer].mouseInterface = true;
                        ...
                        ItemSlot.Draw(Main.spriteBatch, ref Main.reforgeItem, 5, new Vector2(num60, num61), default(Color));
                    }
                }
                else if (Main.InGuideCraftMenu)
                {
                    ...
                    else
                    {
                        ...
                        if (Main.guideItem.type > 0)
                        {
                            ...
                            DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, Lang.inter[22].Value, new Vector2(num70, (num71 + 118)), color3, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
                            ...
                            while (num74 < Recipe.maxRequirements)
                            {
                                ...
                                if (Main.recipe[Main.availableRecipe[num72]].requiredTile[num74] == -1)
                                {
                                    ...
                                    {
                                        DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, Lang.inter[23].Value, new Vector2(num70, (num71 + 118 + num75)), color3, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
                                        break;
                                    }
                                    break;
                                }
                                ...
                                {
                                    num73++;
                                    DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, Lang.GetMapObjectName(MapHelper.TileToLookup(Main.recipe[Main.availableRecipe[num72]].requiredTile[num74], 0)), new Vector2(num70, (num71 + 118 + num75)), color3, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
                                    num74++;
                                }
                            }
                            if (Main.recipe[Main.availableRecipe[num72]].needWater)
                            {
                                ...
                                DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, Lang.inter[53].Value, new Vector2(num70, (num71 + 118 + num76)), color3, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
                            }
                            if (Main.recipe[Main.availableRecipe[num72]].needHoney)
                            {
                                int num77 = (num73 + 1) * 26;
                                DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, Lang.inter[58].Value, new Vector2(num70, (num71 + 118 + num77)), color3, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
                            }
                            if (Main.recipe[Main.availableRecipe[num72]].needLava)
                            {
                                int num78 = (num73 + 1) * 26;
                                DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, Lang.inter[56].Value, new Vector2(num70, (num71 + 118 + num78)), color3, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
                            }
                            if (Main.recipe[Main.availableRecipe[num72]].needSnowBiome)
                            {
                                int num79 = (num73 + 1) * 26;
                                DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, Lang.inter[123].Value, new Vector2(num70, (num71 + 118 + num79)), color3, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
                            }
                        }
                        else
                        {
                        ...
                        DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, text4, new Vector2((num70 + 50), (num71 + 12)), new Color(Main.mouseTextColor, Main.mouseTextColor, Main.mouseTextColor, Main.mouseTextColor), 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
                        new Color(100, 100, 100, 100);
                        if (Main.mouseX >= num70 && Main.mouseX <= num70 + Main.inventoryBackTexture.Width * Main.inventoryScale && Main.mouseY >= num71 && Main.mouseY <= num71 + Main.inventoryBackTexture.Height * Main.inventoryScale && !PlayerInput.IgnoreMouseInterface)
                        {
                            Main.player[Main.myPlayer].mouseInterface = true;
                            Main.craftingHide = true;
                            if (Main.mouseLeftRelease && Main.mouseLeft)
                        ...
                        ItemSlot.Draw(Main.spriteBatch, ref Main.guideItem, 7, new Vector2(num70, num71), default(Color));
                    }
                }
                if (!Main.InReforgeMenu)
                {
                    ...
                    {
                        DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, Lang.inter[25].Value, new Vector2(76f, (414 + num58)), color3, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
                    }
                    for (int num80 = 0; num80 < Recipe.maxRecipes; num80++)
                    {
                        ...
                        if (num80 < Main.numAvailableRecipes && Math.Abs(Main.availableRecipeY[num80]) <= num59)
                        {
                            ...
                            {
                                num83 = (double)(150f * (100f - (Math.Abs(Main.availableRecipeY[num80]) - (num59 - 100f)))) * 0.01;
                                num84 = (double)(255f * (100f - (Math.Abs(Main.availableRecipeY[num80]) - (num59 - 100f)))) * 0.01;
                            }
                            ...
                            if (Main.mouseX >= num81 && Main.mouseX <= num81 + Main.inventoryBackTexture.Width * Main.inventoryScale && Main.mouseY >= num82 && Main.mouseY <= num82 + Main.inventoryBackTexture.Height * Main.inventoryScale && !PlayerInput.IgnoreMouseInterface)
                            {
                                Main.player[Main.myPlayer].mouseInterface = true;
                    ...
                    if (Main.numAvailableRecipes > 0)
                    {
                        ...
                        for (int num85 = 0; num85 < Recipe.maxRequirements; num85++)
                        {
                            ...
                            if (Main.mouseX >= num86 && Main.mouseX <= num86 + Main.inventoryBackTexture.Width * Main.inventoryScale && Main.mouseY >= num87 && Main.mouseY <= num87 + Main.inventoryBackTexture.Height * Main.inventoryScale && !PlayerInput.IgnoreMouseInterface)
                            {
                                Main.craftingHide = true;
                                Main.player[Main.myPlayer].mouseInterface = true;
                            ...
                            ItemSlot.Draw(Main.spriteBatch, ref Main.recipe[Main.availableRecipe[Main.focusRecipe]].requiredItem[num85], 22, new Vector2(num86, num87), default(Color));
                ...
                if (Main.recBigList)
                {
                    ...
                    if (Main.recStart > 0)
                    {
                        ...
                        Main.spriteBatch.Draw(Main.craftUpButtonTexture, new Vector2(num102, num103), new Rectangle?(new Rectangle(0, 0, Main.craftUpButtonTexture.Width, Main.craftUpButtonTexture.Height)), new Color(200, 200, 200, 200), 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
                    }
                    if (Main.recStart < Main.numAvailableRecipes - num96 * num97)
                    {
                        num103 += 20;
                        ...
                        Main.spriteBatch.Draw(Main.craftDownButtonTexture, new Vector2(num102, num103), new Rectangle?(new Rectangle(0, 0, Main.craftUpButtonTexture.Width, Main.craftUpButtonTexture.Height)), new Color(200, 200, 200, 200), 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
                    }
                    ...
                    while (num104 < Recipe.maxRecipes && num104 < Main.numAvailableRecipes)
                    {
                        ...
                        if (Main.mouseX >= num105 && Main.mouseX <= num105 + Main.inventoryBackTexture.Width * Main.inventoryScale && Main.mouseY >= num106 && Main.mouseY <= num106 + Main.inventoryBackTexture.Height * Main.inventoryScale && !PlayerInput.IgnoreMouseInterface)
                        {
                            Main.player[Main.myPlayer].mouseInterface = true;
                            if (Main.mouseLeftRelease && Main.mouseLeft)
                            {
                        ...
                        if (Main.numAvailableRecipes > 0)
                        {
                            ...
                            ItemSlot.Draw(Main.spriteBatch, ref Main.recipe[Main.availableRecipe[num104]].createItem, 22, new Vector2(num105, num106), default(Color));
                ...
                DynamicSpriteFontExtensionMethods.DrawString(Main.spriteBatch, Main.fontMouseText, Lang.inter[26].Value, new Vector2(39 + (int)(600 * scale), 140f + (vector2.Y - vector2.Y * num109) / 2f), new Color(Main.mouseTextColor, Main.mouseTextColor, Main.mouseTextColor, Main.mouseTextColor), 0f, default(Vector2), 0.75f * num109, SpriteEffects.None, 0f);
                Main.inventoryScale = 0.6f;
                for (int num110 = 0; num110 < 4; num110++)
                {
                    ...
                    int slot = num110 + 50;
                    new Color(100, 100, 100, 100);
                    if (Main.mouseX >= num111 && Main.mouseX <= num111 + Main.inventoryBackTexture.Width * Main.inventoryScale && Main.mouseY >= num112 && Main.mouseY <= num112 + Main.inventoryBackTexture.Height * Main.inventoryScale && !PlayerInput.IgnoreMouseInterface)
                    {
                        Main.player[Main.myPlayer].mouseInterface = true;
                    ...
                    ItemSlot.Draw(Main.spriteBatch, Main.player[Main.myPlayer].inventory, 1, slot, new Vector2(num111, num112), default(Color));
                }
                ...
                for (int num114 = 0; num114 < 4; num114++)
                {
                    ...
                    int slot2 = 54 + num114;
                    new Color(100, 100, 100, 100);
                    if (Main.mouseX >= num115 && Main.mouseX <= num115 + Main.inventoryBackTexture.Width * Main.inventoryScale && Main.mouseY >= num116 && Main.mouseY <= num116 + Main.inventoryBackTexture.Height * Main.inventoryScale && !PlayerInput.IgnoreMouseInterface)
                    {
                        Main.player[Main.myPlayer].mouseInterface = true;
                ...
                if (Main.npcShop > 0 && !Main.recBigList)
                {
                    ...
                    if (Main.mouseX > 73 && Main.mouseX < (int)(73f + 560f * Main.inventoryScale) && Main.mouseY > main.invBottom && Main.mouseY < (int)(main.invBottom + 224f * Main.inventoryScale) && !PlayerInput.IgnoreMouseInterface)
                    {
                        Main.player[Main.myPlayer].mouseInterface = true;
                    }
                    for (int num117 = 0; num117 < 10; num117++)
                    {
                        for (int num118 = 0; num118 < 4; num118++)
                        {
                            ...
                            new Color(100, 100, 100, 100);
                            if (Main.mouseX >= num119 && Main.mouseX <= num119 + Main.inventoryBackTexture.Width * Main.inventoryScale && Main.mouseY >= num120 && Main.mouseY <=  num120 +  Main.inventoryBackTexture.Height * Main.inventoryScale && !PlayerInput.IgnoreMouseInterface)
                            {
                                Main.player[Main.myPlayer].mouseInterface = true;
                                if (Main.mouseLeftRelease && Main.mouseLeft)
                                {
                            ...
                            ItemSlot.Draw(Main.spriteBatch, main.shop[Main.npcShop].item, 15, slot3, new Vector2(num119, num120), default(Color));
                        }
                    }
                }
                ...
                if (Main.player[Main.myPlayer].chest == -1 && Main.npcShop == 0)
                {
                    ...
                    Main.spriteBatch.Draw(Main.chestStackTexture[num121], new Vector2(num122, num123), new Rectangle?(new Rectangle(0, 0, Main.chestStackTexture[num121].Width, Main.chestStackTexture[num121].Height)), Color.White, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
                ...
                if (Main.player[Main.myPlayer].chest == -1 && Main.npcShop == 0)
                {
                    ...
                    Main.spriteBatch.Draw(texture2, new Vector2(num125, num126), null, Color.White, 0f, default(Vector2), 1f, SpriteEffects.None, 0f);
